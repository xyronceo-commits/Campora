            ...
            <table className="w-full text-left text-xs text-slate-800 dark:text-slate-200">
              <thead className="bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 font-bold uppercase text-[10px] text-slate-400">
                <tr>
                  ...
                  <th className="p-4">Room Vacancy</th>
                  <th className="p-4">Student Saves</th>
                ...
                {agentListings.map(listing => (
                  <tr key={listing.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-700/30">
                    ...
                    <td className="p-4 font-extrabold text-emerald-600 dark:text-emerald-400">
                      ₦{new Intl.NumberFormat().format(listing.price)} / yr
                    </td>
                    <td className="p-4 font-semibold">
                      {listing.isOccupied ? (
                        <span className="text-rose-500 font-bold">0 (Fully Occupied)</span>
                      ) : (
                        <span className="text-emerald-600 font-bold">{listing.availableRooms} of {listing.totalRooms} free</span>
                      )}
                    </td>
                    <td className="p-4 font-bold text-indigo-600 dark:text-indigo-400">
                      ♥ {listing.savesCount || 12}
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4 text-right space-x-2">
                      ...
                      >
                        {listing.isOccupied ? 'Mark Available' : 'Mark Fully Booked'}
                      </button>
                    </td>
                  </tr>
                ))}
