    ...
    <header className="sticky top-0 z-50 w-full bg-white dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-emerald-600 text-white flex items-center justify-center shadow-md shrink-0 group-hover:scale-105 transition-transform">
              <div className="w-4 h-4 bg-white rounded-sm rotate-45 shadow-sm" />
            </div>
            <div>
              <span className="text-xl font-extrabold tracking-tight text-slate-900 dark:text-white flex items-center gap-1 uppercase">
                CAMPORA
              </span>
              <span className="block text-[10px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest -mt-1">
                Student Housing
              </span>
            </div>
          </button>
          ...
          <div className="relative hidden md:block">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-800 text-xs font-semibold text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-800 transition-colors"
            >
        ...
        <div className="flex items-center gap-2">
              ...
              {isVerticalNavOpen && (
                ...
                >
                  ...
                  <div className="flex flex-col gap-1 py-1 text-xs font-bold">
                    ...
                    {/* Theme Toggle option inside Vertical Nav */}
                    <div className="my-1 border-t border-slate-100 dark:border-slate-800" />
                    <button
                      onClick={() => {
                        toggleTheme();
                      }}
                      className="w-full px-3 py-2.5 rounded-xl text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all flex items-center justify-between text-left"
                    >
                      <div className="flex items-center gap-2.5">
                        {theme === 'dark' ? (
                      ...
                      <span className="px-2 py-0.5 rounded-md text-[10px] font-extrabold uppercase bg-emerald-100 dark:bg-slate-800 text-emerald-800 dark:text-emerald-300">
                        {theme === 'dark' ? 'Dark Mode' : 'White / Green'}
                      </span>
                    </button>
                  </div>
                </motion.div>
          ...
          {/* White / Green & Dark Mode Header Toggle Button */}
          <button
            onClick={toggleTheme}
            ...
            title={theme === 'dark' ? 'Switch to White/Green Light Theme' : 'Switch to Dark Mode'}
          ...
          >
            {theme === 'dark' ? (
              ...
              <>
                ...
                <span className="hidden sm:inline text-[11px]">White / Green</span>
              </>
            )}
          </button>
